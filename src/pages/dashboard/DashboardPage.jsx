      ...
      <div className="hidden lg:block px-6 py-6 space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          <StatCard title={
            ...
            value={isLoading ? '...' : (hideBalance ? formatRupiah(data?.balance, prefs).replace(/[0-9].*$/, '•••••••') : formatRupiah(data?.balance, prefs))}
      ...
      <div className="lg:hidden px-4 py-4 space-y-4 pb-24">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white rounded-xl border border-gray-100 border-l-4 border-l-[#22c55e] p-3.5 shadow-sm">
            ...
            <p className="text-base font-black text-gray-900 leading-tight">{isLoading ? '...' : (hideBalance ? formatRupiah(data?.balance, prefs).replace(/[0-9].*$/, '•••••••') : formatRupiah(data?.balance, prefs))}</p>
